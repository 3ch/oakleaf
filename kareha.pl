...
sub make_anonymous($$$)
{
	...
	return cfg_expand("%G% %W%",
		...
		O => ["Klein","Schnart","Bart","Billing","Schwarz","Sch&auml;k","Tilling","Gut","Werting","Blut","Gr&uuml;n","Enten","Pitt","Gro&szlig;","Bruch","Blater","Bun","Buss","Leh","von Schratt","Pfeil","von Grimm","Honig","Licht","Mord","Nickel","Pick","Pock","Trot","Tut","Turm"],
		E => ["ford","mann","stein","sohn","heim","gold","bank","fu&szlig;","werth","weg","halle","dock","furt","quell","berg","stock","feld","schloss","tal","wasser","dorf","schlucht","ville","speer","furth","will"],
		G => ["Albert","Adele","Adalbert","Archibald","August","Barnabas","Bert","Beatrix","Bettina","Caroline","Cedric","Chlodwig","Charlotte","Clara","Cornelius","Christian","David","Doris","Eberhard","Edward","Edwin","Elisa","Emma","Ernst","Esther","Eugen","Fanny","Frederick","Georg","Gustav","Hubert","Hanna","Hedda","Henry","Hugo","Igor","Isabelle","Jakob","Johannes","Jochen","Jennifer","Johann","Lilli","Lydia","Martha","Martin","Matilde","Maria","Nathaniel","Nele","Nikolas","Nepumuk","Oliver","Phillip","Peter","Phyllis","Polly","Priscilla","Rebecca","Ruben","Samuel","Simon","Sebastian","Sophie","Thomas","Walter","Wolfgang","Wilhelm"],
	);
}
...
sub trim_threads()
{
	...
	while(@threads>$max_threads or $posts>$max_posts or $size>$max_size)
	{
		...
		permasage_thread($$thread{thread});
	}
